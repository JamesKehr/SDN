...
function Remove-HNSHostEndpoint
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $EndpointID
...
Export-ModuleMember -Function Add-HNSHostEndpoint
Export-ModuleMember -Function Add-HNSVMEndpoint
Export-ModuleMember -Function Add-HNSEndpoint
Export-ModuleMember -Function Remove-HNSHostEndpoint
Export-ModuleMember -Function Remove-HNSVMEndpoint
